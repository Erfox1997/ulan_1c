...
return [
    ...
    [
        ...
        'children' => [
            ...
            ['label' => 'Продажа физлицам', 'route' => 'admin.retail-sales.index', 'route_is' => 'admin.retail-sales.*', 'route_is_not' => ['admin.retail-sales.debts', 'admin.retail-sales.history']],
            ['label' => 'История продаж', 'route' => 'admin.retail-sales.history', 'route_is' => 'admin.retail-sales.history'],
    ...
    [
        ...
        'children' => [
            ...
            ['label' => 'ТНВЭД/ГКЭД коды', 'route' => 'admin.accounting.tn-ved-gked-codes', 'route_is' => 'admin.accounting.tn-ved-gked-codes*'],
        ],
    ],
    [
        'id' => 'goods-services',

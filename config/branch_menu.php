...
return [
    ...
    [
        ...
        'children' => [
            ...
            ['label' => 'Продажа физлицам', 'route' => 'admin.retail-sales.index', 'route_is' => 'admin.retail-sales.*'],
    ...
    [
        ...
        'children' => [
            ...
            ['label' => 'Товары: остатки', 'route' => 'admin.stock.report-balances', 'route_is' => 'admin.stock.report-balances*'],
        ],
    ],
    [
        'id' => 'payroll',
        ...
        'icon' => 'users',
        'children' => [
            ['label' => 'Зарплата', 'route' => 'admin.payroll', 'route_is' => 'admin.payroll'],

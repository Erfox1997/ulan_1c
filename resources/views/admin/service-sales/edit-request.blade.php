<x-admin-layout pageTitle="Заявка №{{ $serviceOrder->id }} — редактирование" main-class="bg-slate-100/80 px-3 py-4 sm:px-4 lg:px-6">
    <div class="mx-auto max-w-6xl space-y-3">
        <div class="flex flex-wrap items-center gap-2 text-sm">
            ...
            <a href="{{ route('admin.service-sales.requests.show', $serviceOrder) }}" class="font-semibold text-slate-600 hover:text-emerald-700 hover:underline">Подробнее и оформление</a>
        </div>
                ...
                <div class="relative z-[100] lg:col-span-5">
                    <div class="rounded-xl border border-slate-200/90 bg-white shadow-md ring-1 ring-slate-900/[0.04]">
                        <div class="space-y-2 p-3">
                            <form method="GET" action="{{ route('admin.service-sales.requests.edit', $serviceOrder) }}" class="flex items-center gap-2">
                                <label for="svc_edit_wh" class="shrink-0 text-[10px] font-bold uppercase tracking-wide text-slate-500">Склад</label>
                                <select
                                    id="svc_edit_wh"
                                    name="warehouse_id"
                ...
                <div class="min-w-0 lg:col-span-7">
                    ...
                    >
                        ...
                        <div class="border-b border-emerald-900/15 px-3 py-2.5 text-white sm:px-4" style="background: linear-gradient(125deg, #047857 0%, #0d9488 55%, #115e59 100%);">
                                    ...
                                    <div class="recipient-kind-sell flex flex-wrap gap-2" role="group" aria-label="Тип получателя">
                                        <label>
                                            <input
                                                ...
                                                name="recipient_kind"
                                                value="physical"
                                                @checked(old('recipient_kind', $serviceOrder->recipient_kind) === 'physical')
                                            />
                                            Физлицо
                                        </label>
                                        <label>
                                            <input
                                                ...
                                                name="recipient_kind"
                                                value="legal"
                                                @checked(old('recipient_kind', $serviceOrder->recipient_kind) === 'legal')
                                            />
                                            Юрлицо
                                        </label>
                                    </div>
                            ...
                            <div class="mt-2">
                                <label for="svc_edit_notes" class="block text-[10px] font-bold uppercase tracking-wide text-teal-100/95">Комментарий</label>
                                <textarea
                                    id="svc_edit_notes"
                                    name="notes"
                                    rows="2"

@php
    ...
    $documentTitle = InvoiceNakladnayaFormatter::documentTitle($purchaseReceipt->document_date, $purchaseReceipt->id);
...
<body>
    @if (! ($forPdf ?? false))
        ...
        @if (isset($printOrganizations) && $printOrganizations->count() > 1)
            @php
                $printUrl = route('admin.purchase-receipts.print', $purchaseReceipt);
                $pdfUrl = route('admin.purchase-receipts.pdf', $purchaseReceipt);
    ...
    <div class="meta-block">
        ...
        <div class="meta-row">
            ...
            <span class="val">{{ $purchaseReceipt->warehouse->name }}</span>
        </div>
        <div class="meta-row">
            <span class="lbl">Поставщик:</span>
            <span class="val">{{ $purchaseReceipt->supplier_name !== '' ? $purchaseReceipt->supplier_name : '—' }}</span>
        </div>
    </div>

<x-admin-layout pageTitle="Новое поступление" main-class="px-3 py-5 sm:px-5 lg:px-7 bg-[#f0f4f8]">
            ...
            @if ($selectedWarehouseId !== 0)
                ...
                <script>
                    window.__purchaseReceiptInit = {
                        ...
                        purchaseReceiptSwitchWarehouseUrl: @json(route('admin.purchase-receipts.create')),
                    ...
                    >
                            ...
                            >
                                <div class="bg-[#008b8b] px-5 py-4 text-white">
                                    <h3 id="pr-finalize-title" class="text-base font-bold tracking-tight">Оформление поступления</h3>
                                ...
                                <div class="space-y-5 px-5 py-5">
                                    <div>
                                        <x-input-label for="pr_finalize_warehouse_id" value="Склад документа *" class="font-semibold text-slate-700" />
                                        <select
                                            id="pr_finalize_warehouse_id"
                                            name="warehouse_id"

<x-admin-layout pageTitle="Контрагент: {{ $counterparty->name }}" main-class="px-3 py-6 sm:px-6 lg:px-8">
    <div class="mx-auto w-full max-w-4xl space-y-6">
        ...
        @include('admin.counterparties.partials.form', ['submitLabel' => 'Сохранить'])
    </div>
</x-admin-layout>

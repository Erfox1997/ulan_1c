<x-admin-layout pageTitle="Изменение услуги" main-class="px-3 py-6 sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden rounded-[1.65rem] bg-gradient-to-b from-white/95 to-slate-50/90">
                <div class="ob-1c-scope overflow-hidden rounded-[1.5rem] bg-white/95">
                    ...
                    >
                        ...
                        <h2 class="text-[15px] font-bold leading-tight text-slate-800">Услуга: {{ $service->name }}</h2>
                    </div>
                    @include('admin.sale-services.partials.form', ['submitLabel' => 'Сохранить'])
                </div>
            </div>
        </div>
    </div>

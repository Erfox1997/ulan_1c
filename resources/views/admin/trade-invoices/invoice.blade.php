...
<body>
    @if (! ($forPdf ?? false))
        <div class="no-print">
            ...
            <span style="margin-left:8px;font-size:10pt;color:#64748b;">PDF — кнопка «Скачать PDF» в списке счетов.</span>
        </div>
    ...
    <div class="meta-block">
        ...
        <div class="meta-row">
            <span class="lbl">Документ-основание:</span>
            <span class="val">Реализация № {{ $legalEntitySale->id }} от {{ $legalEntitySale->document_date->format('d.m.Y') }}, склад «{{ $legalEntitySale->warehouse->name }}»</span>
        </div>
    </div>

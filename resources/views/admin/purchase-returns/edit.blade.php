<x-admin-layout pageTitle="Возврат поставщику (редактирование)" main-class="px-3 py-5 sm:px-4 lg:px-5">
    <div class="w-full min-w-0 space-y-6">
        ...
        @else
            <div class="rounded-xl border border-slate-200/90 bg-white px-5 py-4 shadow-sm ring-1 ring-slate-900/5">
                ...
                <p class="mt-1 text-sm font-medium text-slate-900">{{ $purchaseReturn->warehouse->name }}</p>
            ...
            >
                ...
                <div class="ob-1c-scope rounded-sm border border-[#c0c0c0] bg-white p-0 shadow-sm">
                    <div class="border-b border-[#c0c0c0] bg-[#f5f5f5] px-3 py-2">
                        <h2 class="text-sm font-semibold text-neutral-800">Редактирование возврата поставщику</h2>
                        <p class="mt-0.5 text-[11px] text-neutral-600">Пересохранение пересчитывает складские остатки.</p>
                    </div>
                    ...
                    <div class="ob-1c-header">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="date"
                                name="document_date"
                                value="{{ old('document_date', $purchaseReturn->document_date->format('Y-m-d')) }}"
                                required
                            />
                        </div>
                    </div>

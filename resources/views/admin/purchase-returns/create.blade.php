<x-admin-layout pageTitle="Возврат поставщику (новый)" main-class="px-3 py-6 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <h2 class="text-[15px] font-bold leading-tight text-slate-800">Возврат поставщику</h2>
                            <p class="mt-1.5 text-[11px] leading-snug text-slate-600">
                                Списание только по номенклатуре филиала; количество не больше остатка на складе. Цена возврата — по договорённости.
                            </p>
                        </div>
                            ...
                            <div class="relative" x-ref="supplierRoot">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <label class="block text-[10px] font-semibold text-slate-600" for="prt_cp_quick_legal_form">Правовая форма</label>
                                        <select
                                            id="prt_cp_quick_legal_form"
